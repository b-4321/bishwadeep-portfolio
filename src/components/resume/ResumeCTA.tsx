  ...
  return (
    <section id="resume" className="py-20 px-4 max-w-5xl mx-auto scroll-mt-24">
      <motion.div
        ...
        className="relative rounded-3xl bg-gradient-to-r from-zinc-900 via-zinc-900/90 to-zinc-950 border border-white/[0.1] p-8 sm:p-12 overflow-hidden shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8"
      >
        {/* Ambient Glows */}
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3.5 shrink-0 z-10 w-full sm:w-auto">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.97 }}
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-semibold text-zinc-950 bg-brand-500 hover:bg-brand-400 rounded-xl transition-colors shadow-brand-glow cursor-pointer"
          >
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.03 }}
            whileTap={{ scale: 0.97 }}
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 text-sm font-medium text-zinc-200 hover:text-white bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] rounded-xl transition-colors cursor-pointer"
          >
